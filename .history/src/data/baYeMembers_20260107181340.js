...
// 从缓存读取数据，如果没有则使用默认数据
let cachedMembers = getCache("baYeMembers");
if (!cachedMembers) {
  cachedMembers = defaultBaYeMembers;
  setCache("baYeMembers", cachedMembers);
}

export const baYeMembers = cachedMembers;
