<template>
  <div class="entry-container">
    <div class="entry-content">
      <h1 class="entry-title">燕云十六声</h1>
      <p class="entry-subtitle">WHERE WINDS MEET</p>
      <button class="entry-button" @click="enterBaYe">进入百业</button>
    </div>
  </div>
</template>
...
const carouselImages = [
  "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop&auto=format&q=90",
  "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&auto=format&q=90",
  "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&auto=format&q=90",
...
.entry-container {
  ...
  align-items: center;
  background: linear-gradient(-45deg, #1a1a1a, #2d2d2d, #1a1a1a, #000000);
...
.entry-content:hover .entry-subtitle {
  opacity: 1;
  transform: translateY(0);
}
...
.entry-content:hover .entry-button {
  opacity: 1;
  transform: translateY(0);
}
